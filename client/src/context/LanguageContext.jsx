...
const dictionaries = {
  vi: {
    ...
    auth: {
      ...
      welcomeSub: "Đăng nhập và tiếp tục hành trình on-chain.",
      email: "Email",
      password: "Mật khẩu",
      ...
      createHangar: "Khởi tạo Hangar",
      createHangarSub: "Nhập thông tin để gia nhập hạm đội.",
      ...
      returningRaider: "Returning Raider?",
      jumpBackIn: "Jump back into the action.",
      syncProgress: "Sync your game progress and wallet.",
      feature4: "Access your NFT inventory.",
      feature5: "Join the global leaderboards.",
      feature6: "Trade items on the marketplace.",
      ...
      sendingverificate: "Đang gửi mã xác thực...",
      signUp: "Đăng ký",
  ...
  en: {
    ...
    auth: {
      ...
      welcomeSub: "Plug in and resume your on-chain run.",
      email: "Email",
      password: "Password",
      ...
      createHangar: "Initialize Hangar",
      createHangarSub: "Enter details to join the fleet.",
      ...
      sendingverificate: "Sending verification code...",
      signUp: "Sign up",
